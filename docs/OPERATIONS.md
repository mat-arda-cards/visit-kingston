...
| 6 | **Send the AMS API support email** (docs/chamber/ams-support-email.md) from a Chamber account to websupport@growthzone.com; forward the written reply to Mat so docs/adr/ADR-0001-ams-ground-truth.md can move past BLOCKED-ON-HUMAN. The calendar-wide-feed question is folded into it (question 6); run `npm run ams:checks` to re-verify the machine-checkable half. | Chamber office, 360-860-2239 |
