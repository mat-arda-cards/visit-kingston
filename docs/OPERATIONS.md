...
| 6 | **Send the AMS API support email** (docs/chamber/ams-support-email.md) from a Chamber account to websupport@growthzone.com; forward the written reply to Mat. Informational since ADR-0002 (pricing intel for the 2027 LTAC decision + hot-deals/calendar-feed questions) — no longer blocking; run `npm run ams:checks` to re-verify the machine-checkable half. | Chamber office, 360-860-2239 |
